...
namespace Microsoft.Azure.Search
{
    ...
    internal partial class DocumentsProxyOperations : IServiceOperations<SearchIndexClient>, IDocumentsProxyOperations
    {
        ...
        /// <summary>
        /// Queries for search in the Azure Search index.
        /// </summary>
        /// <param name='searchText'>
        /// search text
        /// </param>
        /// <param name='xSearchParameters'>
        /// Additional parameters for the operation
        /// </param>
        /// <param name='searchRequestOptions'>
        /// Additional parameters for the operation
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<XDocumentSearchResult>> SearchGetWithHttpMessagesAsync(string searchText, XSearchParameters xSearchParameters = default(XSearchParameters), SearchRequestOptions searchRequestOptions = default(SearchRequestOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SearchServiceName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SearchServiceName");
            ...
            if (xSearchParameters != null)
            {
                highlightPreTag = xSearchParameters.HighlightPreTag;
            }
            string highlightPostTag = default(string);
            if (xSearchParameters != null)
            {
                highlightPostTag = xSearchParameters.HighlightPostTag;
            }
            IList<string> select = default(IList<string>);
            if (xSearchParameters != null)
            {
                select = xSearchParameters.Select;
            }
            IList<string> highlights = default(IList<string>);
            if (xSearchParameters != null)
            {
                highlights = xSearchParameters.Highlights;
            }
            IList<string> searchFields = default(IList<string>);
            if (xSearchParameters != null)
            {
                searchFields = xSearchParameters.SearchFields;
            }
            System.Guid? clientRequestId = default(System.Guid?);
            if (searchRequestOptions != null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("highlights", highlights);
            ...
            if (highlights != null)
            {
                _queryParameters.Add(string.Format("highlights={0}", System.Uri.EscapeDataString(string.Join(",", highlights))));
            }
            ...
            // Create Result
            var _result = new AzureOperationResponse<XDocumentSearchResult>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<XDocumentSearchResult>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// <summary>
        /// Queries for suggestions in the Azure Search index.
        /// </summary>
        /// <param name='searchText'>
        /// search text
        /// </param>
        /// <param name='xSuggestParameters'>
        /// Additional parameters for the operation
        /// </param>
        /// <param name='searchRequestOptions'>
        /// Additional parameters for the operation
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<XDocumentSuggestResult>> SuggestGetWithHttpMessagesAsync(string searchText, XSuggestParameters xSuggestParameters, SearchRequestOptions searchRequestOptions = default(SearchRequestOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SearchServiceName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SearchServiceName");
            ...
            if (xSuggestParameters == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "xSuggestParameters");
            }
            if (xSuggestParameters != null)
            {
                xSuggestParameters.Validate();
            }
            string suggesterName = default(string);
            if (xSuggestParameters != null)
            {
                suggesterName = xSuggestParameters.SuggesterName;
            }
            IList<string> select = default(IList<string>);
            if (xSuggestParameters != null)
            {
                select = xSuggestParameters.Select;
            }
            bool? fuzzy = default(bool?);
            if (xSuggestParameters != null)
            {
                fuzzy = xSuggestParameters.Fuzzy;
            }
            System.Guid? clientRequestId = default(System.Guid?);
            if (searchRequestOptions != null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<XDocumentSuggestResult>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<XDocumentSuggestResult>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// <summary>
        /// INCOMPLETE, Indexes docs in the Azure Search index.
        /// </summary>
        /// <param name='indexingRequest'>
        /// </param>
        /// <param name='searchRequestOptions'>
        /// Additional parameters for the operation
        /// </param>
        ...
        public async Task<AzureOperationResponse<DocumentIndexResult>> DocumentIndexPostWithHttpMessagesAsync(IndexingRequest indexingRequest, SearchRequestOptions searchRequestOptions = default(SearchRequestOptions), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (indexingRequest == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "indexingRequest");
            }
            System.Guid? clientRequestId = default(System.Guid?);
            if (searchRequestOptions != null)
            {
            ...
            if (_shouldTrace)
            {
                _invocationId = ServiceClientTracing.NextInvocationId.ToString();
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("indexingRequest", indexingRequest);
                tracingParameters.Add("clientRequestId", clientRequestId);
                tracingParameters.Add("cancellationToken", cancellationToken);
            ...
            if(indexingRequest != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(indexingRequest, Client.SerializationSettings);
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DocumentIndexResult>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
